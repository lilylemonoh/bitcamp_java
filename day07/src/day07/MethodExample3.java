...
public class MethodExample3 {
	 ...
	 * 
	 * 2. 매개 변수는 여러 개를 입력받을 수 있지만 반환값은 오로지 하나여야 합니다.
	 * 
	 ...
	 * 	  매직넘버 대신 사용할 수 있습니다.
	 * 
	 * 6. 반환값이 없는 메서드는 void를 기입합니다. 이때는 return 구문을 쓰지 않아도 됩니다. (쓰는 경우도 ㅇ,break문처럼)
	 * 
	...
	public static void callMyName(String name) {
		// 문자열도 배열이므로 .length로 문자 개수를 셀 수 있습니다.
		if(name.length() < 2 ) {
...
//		System.out.println(add(3, 5)와 결과 동일);
		...
		callMyName("김자바"); // 반환값이 void이며 return 구문 실행 안 됨
