...
public class ListExample {
	...
	public static void main(String[] args) {
		...
		// 제네릭 : 타입 안정화를 위해 객체 내부에 저장되는 타입을 일치시키는 방밥
		// String만 저장할 수 있는 컬렉션
//		List<String> list = new ArrayList<>(); // 1.8부터는 생성자에 제네릭 표기 안 해도 됨
		List<String> list = new LinkedList<>();
		// 어떤 걸 써도 된다.
		// List의 <> 안에 기본형을 넣을 수 없다. int 대신 wrapper 클래스 Integer를 써야 한다.
...
//		list[3] = "PostgreSQL"; // 일반 수정 구문 사용 불가
		...
		int idx = list.indexOf("Network"); // 없는 자료 조회 시 -1
